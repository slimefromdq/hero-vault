...
Three lanes connect the northeast blue vault to the southwest red vault.

- **Top** is a long, narrow 1v1. Help takes the long jungle walk.
- **Mid** is the short diagonal. Rotations use river cuts into either sidelane.
- **Bottom** is a wide duo lane. Bushes block shots that try to pass through, so fights linger in cover.

Default assignment is one top, one mid, two bottom, one jungle roam. Old north/south/roam saves migrate automatically.

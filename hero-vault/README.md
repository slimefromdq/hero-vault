...
A Godot 4.7.2 MOBA autobattler and spectator simulation. Choose five heroes, assign top, mid, bottom or roam, and spend a shared 18-point item budget. Watch three autonomous battles and win two of three.
...
- `scripts/map_layout.gd`: three-lane geometry, cover and jungle rotation paths.
